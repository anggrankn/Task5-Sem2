package ru.vsu.cs.tree.gui;

import com.intellij.uiDesigner.core.GridConstraints;
import com.intellij.uiDesigner.core.GridLayoutManager;
import com.intellij.uiDesigner.core.Spacer;
import ru.vsu.cs.tree.BinaryTreeAlgorithms;
import ru.vsu.cs.tree.SimpleBinaryTree;
import ru.vsu.cs.tree.BinaryTreePainter;
import ru.vsu.cs.tree.BinaryTree;
import ru.vsu.cs.tree.bst.BSTree;
import ru.vsu.cs.tree.bst.BSTreeAlgorithms;
import ru.vsu.cs.tree.bst.SimpleBSTree;
...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton getMinValue;
    private JButton getMaxValue;
    ...
    public TreeDemoFrame() {
        ...
        getMinValue.addActionListener(e -> {
            try {
            ...
            BinaryTree.TreeNode<Integer> res = BSTreeAlgorithms.getFloorNode(tree.getRoot(), Integer.parseInt(textField1.getText()));
            textField1.setText(String.valueOf(res.getValue()));

        });

        getMaxValue.addActionListener(e -> {
            try {
                SimpleBinaryTree<Integer> tree = new SimpleBinaryTree<>(Integer::parseInt);
                tree.fromBracketNotation(textFieldBracketNotationTree.getText());
                this.tree = tree;
            ...
            BinaryTree.TreeNode<Integer> res = BSTreeAlgorithms.getCeilingNode(tree.getRoot(), Integer.parseInt(textField2.getText()));
            textField2.setText(String.valueOf(res.getValue()));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        getMinValue = new JButton();
        getMinValue.setText("Минимальное значение");
        panel2.add(getMinValue, new GridConstraints(2, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        getMaxValue = new JButton();
        getMaxValue.setText("Максимальное значение");
        panel2.add(getMaxValue, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        textField1 = new JTextField();
        panel2.add(textField1, new GridConstraints(3, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        textField2 = new JTextField();
        panel2.add(textField2, new GridConstraints(3, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
